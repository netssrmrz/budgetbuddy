...
public class Db
{
  ...
  public void Delete(String from, String where, Object ... params)
  {
    String[] sqlite_params=null;
    ...
    {
      sqlite_params=BuildSQLParams(params);
      this.conn.delete(from, where, sqlite_params);
    }
  }
  ...
  public Object SelectObj(Class<? extends Object> obj_class, int id)
  {
  ...
  public void Insert(Object obj)
  {
    ...
    if (obj!=null && rs.android.Util.NotEmpty(this.conn))
    {
      ...
      if (rs.android.Util.NotEmpty(values) && TableAvail(obj))
      {
        table_name=DeriveTableName(obj.getClass());
        this.conn.insert(table_name, null, values);
  ...
  public void Update(Object obj)
  {
    ...
    if (obj!=null && rs.android.Util.NotEmpty(this.conn))
    {
      ...
      {
        id=(Integer)Util.GetObjFieldValue(obj, "id");
        id_param=new String[1];
        id_param[0]=Util.To_String(id);
        this.conn.update(table_name, values, "id=?", id_param);
      }
    }
  }
