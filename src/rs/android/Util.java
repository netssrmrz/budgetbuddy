...
public class Util
{
  public static final String log_tag="VelocityDial_Util";
  ...
  public static void SetObjFieldValue(Object obj, String field_name, Object val)
  {
    java.lang.reflect.Method method;
    java.lang.reflect.Field field;
    Class<? extends Object> class_type;
  ...
  {
    return AppendStr(obja, objb, div, null, null, null);
  }
  
  public static String AppendStr(Object obja, Object objb, String div, String def)
  {
    return AppendStr(obja, objb, div, def, null, null);
  }
  
  public static String AppendStr(Object obja, Object objb, String div, String def, String env)
  {
    return AppendStr(obja, objb, div, def, env, env);
  }
  
  public static String AppendStr(Object obja, Object objb, String div, String def, String open_env, String close_env)
  {
    ...
    if (NotEmpty(objs))
    {
      ...
      for (Object obj: objs)
      {
        if (NotEmpty(field_name))
          ...
          val=obj;
        res=AppendStr(res, val, separator, null, envelope, envelope);
      }
    }
    return res;
  }
