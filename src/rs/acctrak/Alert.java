...
public class Alert
{
  ...
  public static void Update_From_SMS(android.content.Context context, Update_Function process)
  {
    Db db;
  ...
  public static int Update_From_SMS(Db db, android.content.Context context, Update_Function process)
  {
    Object[] ids=null;
    rs.android.Sms sms;
    rs.android.Content android_db;
  ...
  public static void Update_From_Emails(android.content.Context context, rs.android.Mail mail, Update_Function process)
  {
    Db db;
  ...
  public static int Update_From_Emails(Db db, android.content.Context context, rs.android.Mail mail, Update_Function process)
  {
